    ...
    <div className="min-h-screen bg-black text-white scroll-smooth">
      ...
      <section id="pricing" className="relative z-10 py-16 px-4 scroll-mt-20">
        <div className="container mx-auto mb-8 text-center">
          {/* Urgency Tag */}
          <div className="hidden items-center gap-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 backdrop-blur-sm border border-orange-500/50 rounded-full px-6 py-3 mb-8">
